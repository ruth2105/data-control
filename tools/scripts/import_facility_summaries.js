// Run this in the browser console to import all facility summaries
// This stores summaries separately from customer data, so they work for ANY hospital in visit reports
...
(function() {
    ...
    console.log('Parsed', Object.keys(summaries).length, 'facility summaries');
    
    // Save to separate localStorage key
    localStorage.setItem('fremenatos_facility_summaries', JSON.stringify(summaries));
    
    console.log('✅ Facility summaries saved to localStorage!');
    console.log('Stored under key: fremenatos_facility_summaries');
    console.log('Now visit reports will show these summaries for matching hospitals.');
})();
